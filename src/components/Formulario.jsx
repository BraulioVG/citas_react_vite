...
const Formulario = ({pacientes, setPacientes, paciente, setPaciente}) => {
  ...
  return (
    <div className='md:w-1/2 lg:w-2/5 mx-5'>
        ...
        <p className='text-lg mt-5 text-cente text-center mb-10'>
          Añade Pacientes y {''}
    ...
    <form className='bg-white shadow-md rounded-lg py-10 px-5 mb-10' onSubmit={handleSubmit}>
      ...
      <input type="submit" className='bg-indigo-600 w-full p-3 text-white uppercase font-bold hover:bg-indigo-700 rounded-sm cursor-pointer transition-all' 
